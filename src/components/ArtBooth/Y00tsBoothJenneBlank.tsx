...
function Y00tsBoothJenneBlank() {
    ...
    const toggleOverlayHead = (overlayImage: string, upperoverlayImage: string, outfitType: string, y00tAttributes: { head?: string; headlowerlevel?: string; clothes?: string; face?: string; fur?: string; eyewear?: string; background?: string; }) => {
        setSelectedOutfitHead((prevSelectedOutfitHead) =>
            prevSelectedOutfitHead === overlayImage ? "" : overlayImage
        );

        setSelectedOutfitHeadUpper((prevSelectedOutfitHeadUpper) =>
            prevSelectedOutfitHeadUpper === upperoverlayImage ? "" : upperoverlayImage
        );
                            ...
                            >
                                ...
                                {outfits8.map((outfit, index) => (
                                    <div
                                        key={index}
                                        onClick={() => {
                                            toggleOverlayHead(outfit.overlayImage, outfit.upperoverlayImage, 'outfit', y00tAttributes);
...
export default Y00tsBoothJenneBlank;
