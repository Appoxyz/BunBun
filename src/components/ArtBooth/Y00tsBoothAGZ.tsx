...
function Y00tsBoothAGZ() {
    ...
    const toggleOverlayClothing = (overlayImage: string, outfitType: string, y00tAttributes: { head?: string; headlowerlevel?: string; clothes?: string; face?: string; fur?: string; eyewear?: string; background?: string; }) => {
        setSelectedOutfitClothing((prevSelectedOutfitClothing) =>
            prevSelectedOutfitClothing === overlayImage ? "" : overlayImage
        );

        if (selectedOutfitClothing === overlayImage) {
    ...
    const toggleOverlayHead = (overlayImage: string, outfitType: string, y00tAttributes: { head?: string; headlowerlevel?: string; clothes?: string; face?: string; fur?: string; eyewear?: string; background?: string; }) => {
        setSelectedOutfitHead((prevSelectedOutfitHead) =>
            prevSelectedOutfitHead === overlayImage ? "" : overlayImage
        );

        if (selectedOutfitHead === overlayImage) {
                    ...
                    <div className="flex flex-col items-start justify-top h-full relative">
                        ...
                        <section className="w-full" >
                            ...
                            >
                                ...
                                {outfits12.map((outfit, index) => (
                                    <div
                                        key={index}
                                        onClick={() => {
                                            toggleOverlayHead(outfit.overlayImage, 'outfit', y00tAttributes);
                                            setActiveOutfitHead(outfit.name);
                                            console.log(ActiveOutfitHead);
                                        }}
                                        style={{
                                            ...
                                            borderRadius: "16px",
                                            ...(selectedOutfitHead === outfit.overlayImage && { // Check against outfit name
                        ...
                        <section className="w-full" >
                            ...
                            >
                                {/* Render outfits from 'outfits' constant */}
                                {outfits10.map((outfit, index) => (
                                    <div
                                        key={index}
                                        onClick={() => {
                                            toggleOverlayEyewear(outfit.overlayImage, 'outfit', y00tAttributes);
                                            setActiveOutfitEyewear(outfit.name);
                                            console.log(ActiveOutfitEyewear);
                                        }}
                                        style={{
                                            border: "2px solid transparent",
                                            width: "85px", // Add fixed width to maintain consistent size
                                            height: "85px", // Add fixed height to maintain consistent size
                                            borderRadius: "16px",
                                            ...(selectedOutfitEyewear === outfit.overlayImage && { // Check against outfit name
                                                border: "2px solid black",
                        ...
                        <section className="w-full" >
                            ...
                            >
                                {/* Render outfits from 'outfits' constant */}
                                {outfits11.map((outfit, index) => (
                                    <div
                                        key={index}
                                        onClick={() => {
                                            toggleOverlayClothing(outfit.overlayImage, 'outfit', y00tAttributes);
                                            setActiveOutfitClothing(outfit.name);
                                            console.log(ActiveOutfitClothing);
                                        }}
                                        style={{
                                            border: "2px solid transparent",
                                            width: "85px", // Add fixed width to maintain consistent size
                                            height: "85px", // Add fixed height to maintain consistent size
                                            borderRadius: "16px",
                                            ...(selectedOutfitClothing === outfit.overlayImage && { // Check against outfit name
                                                border: "2px solid black",
                            ...
                            >
                                ...
                                {outfits9.map((outfit, index) => (
                                    <div
                                        key={index}
                                        onClick={() => {
                                            toggleOverlayBg(outfit.overlayImage, 'outfit', y00tAttributes);
                                            setActiveOutfitBg(outfit.name);
                                            console.log(ActiveOutfitBg);
                                        }}
                                        style={{
                                            border: "2px solid transparent",
                                            width: "85px", // Add fixed width to maintain consistent size
                                            height: "85px", // Add fixed height to maintain consistent size
                                            borderRadius: "16px",
                                            ...(selectedOutfitBg === outfit.overlayImage && { // Check against outfit name
                                                border: "2px solid black",
